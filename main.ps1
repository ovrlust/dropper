...
function Start-BrowserDebug {
    ...
    $psi.Arguments = "--headless --disable-gpu --disable-extensions --remote-debugging-port=$DEBUG_PORT --remote-allow-origins=* --no-default-browser-check --no-first-run --user-data-dir=`"$UserDataPath`""
